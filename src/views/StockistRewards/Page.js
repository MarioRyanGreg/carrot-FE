...
class Page extends Component {
    ...
    headerTable = () => [{
        ...
        key: 'header-column-type',
        title: 'Type',
        dataIndex: 'type'
    }, {
        key: 'header-column-type2',
        title: 'Carrot',
        dataIndex: 'carrot',
        // render: text => <a href="javascript:;">{text}</a>,
        sorter: (a, b) => a.carrot - b.carrot,
                    ...
                    ? (
                        <span>
                            <Popconfirm title="Sure to delete?" onConfirm={() => this.handleDelete(record.id)}>
                                <a className="ant-btn ant-btn-success" href="javascript:;"><Icon type="delete" /> Activate</a>
                            </Popconfirm>
                        </span>
                    ) : (
                        <span>
                            <Popconfirm title="Sure to delete?" onConfirm={() => this.handleDelete(record.id)}>
                                <a className="ant-btn ant-btn-danger" href="javascript:;"><Icon type="delete" /> Deactivate</a>
                            </Popconfirm>
                        </span>
                    )
            );
